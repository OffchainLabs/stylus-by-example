...
----
## 11. Full Example
This example is a simple counter contract that allows you to increment, decrement, and set a number. It also includes unit tests for the contract's functionality.
