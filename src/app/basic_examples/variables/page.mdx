...
- [Solidity docs - state variables](https://docs.soliditylang.org/en/stable/structure-of-a-contract.html#state-variables)
- [Solidity docs - global variables](https://docs.soliditylang.org/en/stable/cheatsheet.html#global-variables)
...
impl Contract {
    ...
    pub fn init(&mut self) -> Result<(), Vec<u8>> {
        ...
        // which we get from the inbuilt Stylus contracts
        let new_owner = self.vm().msg_sender();
