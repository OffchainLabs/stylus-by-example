...
- [Alloy docs (v1.0)](https://docs.rs/alloy-primitives/1.0.0/alloy_primitives/index.html)
  - [`Address`](https://docs.rs/alloy-primitives/1.0.0/alloy_primitives/struct.Address.html)
  - [`Signed`](https://docs.rs/alloy-primitives/1.0.0/alloy_primitives/struct.Signed.html)
  - [`Uint`](https://docs.rs/ruint/1.0.0/ruint/struct.Uint.html)
...
# Example
<FileCodeBlock
  filePath="example_code/external/primitive_data_types/src/lib.rs"
  language="rust"
  title="src/lib.rs"
/>
<FileCodeBlock
  filePath="example_code/external/primitive_data_types/Cargo.toml"
  language="toml"
  title="Cargo.toml"
/>
<FileCodeBlock
  filePath="example_code/external/primitive_data_types/src/main.rs"
  language="rust"
  title="src/main.rs"
/>