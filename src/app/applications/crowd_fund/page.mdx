export const metadata = {
  title: 'Crowd Fund • Stylus by Example',
  description: 'An example implementation of the Crowd Fund in Rust using Arbitrum Stylus.',
};
...
An Arbitrum Stylus version implementation of [Solidity Crowd Fund](https://solidity-by-example.org/app/crowd-fund/).
