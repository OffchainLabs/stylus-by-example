...
An Arbitrum Stylus version implementation of [Solidity MutiSig wallet](https://solidity-by-example.org/app/multi-sig-wallet/).
...
Here is the interface for MutiSig wallet.
